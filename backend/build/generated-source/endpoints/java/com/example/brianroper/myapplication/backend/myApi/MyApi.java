 ...
 * on 2016-05-14 at 14:44:09 UTC 
 * Modify at your own risk.
 */

package com.example.brianroper.myapplication.backend.myApi;
...
public class MyApi extends com.google.api.client.googleapis.services.json.AbstractGoogleJsonClient {
  ...
  public class SayHi extends MyApiRequest<com.example.brianroper.myapplication.backend.myApi.model.MyBean> {
    ...
    protected SayHi(java.lang.String name) {
      super(MyApi.this, "POST", REST_PATH, null, com.example.brianroper.myapplication.backend.myApi.model.MyBean.class);
   ...
   * @return the request
   */
  public ShowJoke showJoke(java.lang.String joke) throws java.io.IOException {
    ShowJoke result = new ShowJoke(joke);
    initialize(result);
    return result;
  }

  public class ShowJoke extends MyApiRequest<com.example.brianroper.myapplication.backend.myApi.model.MyBean> {

    private static final String REST_PATH = "showJoke/{joke}";
     ...
     * @since 1.13
     */
    protected ShowJoke(java.lang.String joke) {
      super(MyApi.this, "POST", REST_PATH, null, com.example.brianroper.myapplication.backend.myApi.model.MyBean.class);
    ...
    public ShowJoke setJoke(java.lang.String joke) {
      this.joke = joke;
      return this;
    }
